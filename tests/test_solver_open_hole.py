"""
Open-hole modal-determinant tests: n=0 Stoneley, n=1 flexural, n=2
quadrupole, and the leaky scaffolding under all three.

One of six modules split out of ``tests/test_cylindrical_solver.py``
(26,376 lines, 741 cases). This one holds the original phase-1 work --
the closed-form White (1983) low-frequency tie, the bound dispersion
batteries, and plan items B through E, where the leaky branches were
first built.
"""
