...
**What is still open, and it is the important half**: neither registered file is
a full-waveform sonic gather, so the sonic processing chain is still validated
