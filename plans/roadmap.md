...
* **The P-pick failure above.** It is a genuine defect in the picking chain,
  invisible to every synthetic test because the synthetics are generated by the
  same forward model the picker is scored against.
