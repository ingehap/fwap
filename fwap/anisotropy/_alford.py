"""
Cross-dipole Alford rotation for shear-wave azimuthal
anisotropy.

Implements the four-component (XX, XY, YX, YY) shear
rotation into the (fast, slow) shear frame per Alford
(1986) and Esmersoy et al. (1994). Extends Mari et al.
(1994), which does not treat cross-dipole rotation.
"""
