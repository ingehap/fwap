"""
Elastic moduli, Gassmann fluid substitution, and effective-medium
averages from sonic velocities.
...
The isotropic moduli use standard small-strain relations; all four
quantities follow from ``Vp``, ``Vs``, and the formation bulk density
``rho``. :func:`gassmann_fluid_substitution` handles fluid replacement
in a saturated frame. The Reuss / Voigt / Hill mixture averages give
the standard effective-medium bounds for an isotropic composite.

Stoneley-wave petrophysical estimators (permeability indicators,
fracture indicators, slow-formation ``V_S`` inversion) live in
:mod:`fwap.stoneley`; they were split out because they form a
self-contained sub-workflow.
...
* Mavko, G., Mukerji, T., & Dvorkin, J. (2009). *The Rock Physics
  Handbook*, 2nd ed., Sections 1.5 and 4.1. Cambridge University
  Press.
"""
